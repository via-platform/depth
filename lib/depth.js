...
module.exports = class Depth {
    ...
    render(){
        return $.div({classList: 'depth'},
            $.div({classList: 'header'},
                $.div({classList: 'bids'},
                    'Sell',
                    $.span({ref: 'bb'}, `0.00 ${this.symbol.base}`),
                    'For',
                    $.span({ref: 'bq'}, `0.00 ${this.symbol.quote}`)
                ),
                ...
                $.div({classList: 'asks'},
                    'Buy',
                    $.span({ref: 'ab'}, `0.00 ${this.symbol.base}`),
                    'For',
                    $.span({ref: 'aq'}, `0.00 ${this.symbol.quote}`)
                )
            ),
    ...
    updateCrosshairValues(){
        ...
        this.crosshairs.main.select('text').text(num(mainPrice).set_precision(2).toString());
        this.crosshairs.shadow.select('text').text(num(shadowPrice).set_precision(2).toString());

        this.refs.bb.textContent = bh.base.set_precision(4).toString() + ' ' + this.symbol.base;
        this.refs.bq.textContent = bh.quote.set_precision(4).toString() + ' ' + this.symbol.quote;

        this.refs.ab.textContent = ah.base.set_precision(4).toString() + ' ' + this.symbol.base;
        this.refs.aq.textContent = ah.quote.set_precision(4).toString() + ' ' + this.symbol.quote;
    }
