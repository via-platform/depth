...
module.exports = class Depth {
    ...
    render(){
        return $.div({classList: 'depth'},
            $.div({classList: 'depth-tools toolbar'},
                $.div({classList: 'symbol btn btn-subtle', onClick: this.change.bind(this)},
    ...
    updateCrosshairValues(){
        ...
        this.crosshairs.main.select('text').text(mainPrice.toFixed(this.market.precision.price));
        this.crosshairs.shadow.select('text').text(shadowPrice.toFixed(this.market.precision.price));
